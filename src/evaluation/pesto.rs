...
pub fn get_pst_score(piece: &Piece, square: &Square) -> (i32, i32) {
    ...
    match piece.color {
        Color::White => (
            middlegame_table[7 - rank as usize][file as usize],
            endgame_table[7 - rank as usize][file as usize],
        ),
        Color::Black => (
            middlegame_table[rank as usize][file as usize],
            endgame_table[rank as usize][file as usize],
        ),
    }
}
